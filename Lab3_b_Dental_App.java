...
public class Lab3_b_Dental_App extends JFrame {
	public Lab3_b_Dental_App() {
		...
		txtMm.addKeyListener((KeyListener) new KeyAdapter() {
		...
		txtDd.addKeyListener((KeyListener) new KeyAdapter() {
			public void keyTyped(KeyEvent e) {
				char c = e.getKeyChar();
				if (!((c >= '0') && (c <= '9') ||
						(c == KeyEvent.VK_BACK_SPACE) ||
		...
		txtYy.addKeyListener((KeyListener) new KeyAdapter() {
			public void keyTyped(KeyEvent e) {
				char c = e.getKeyChar();
				if (!((c >= '0') && (c <= '9') ||
						(c == KeyEvent.VK_BACK_SPACE) ||
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				System.out.println("Days/Hours are you available to work: Thursday: "
						+ comboBox_6.getSelectedItem().toString() + "-" + comboBox_7.getSelectedItem().toString());
				System.out.println("Days/Hours are you available to work: Friday: "
						+ comboBox_8.getSelectedItem().toString() + "-" + comboBox_9.getSelectedItem().toString());
				System.out.println("Days/Hours are you available to work: Saturday: "
						+ comboBox_10.getSelectedItem().toString() + "-" + comboBox_11.getSelectedItem().toString());
				System.out.println("Days/Hours are you available to work: Sunday: "
						+ comboBox_12.getSelectedItem().toString() + "-" + comboBox_13.getSelectedItem().toString());
